...
import { deleteJobApi } from '../../apis/Api';
...
const DashJobs = () => {
    ...
    const deleteJobById = (e, id) => {
        console.log(id)
        //Confirm Dialog Box 
        const confirm = window.confirm('Are you sure want to delete this products')
        if (!confirm) {
            return
        } else {
            deleteJobApi(id).then((res) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            headerName: 'location',
            width: 150,
            valueGetter: (data) => data.row.jobType.description
        },
        // {
        //     field: 'user',
        //     headerName: 'User',
